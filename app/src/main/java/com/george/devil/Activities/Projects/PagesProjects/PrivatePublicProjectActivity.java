...
import com.george.devil.Activities.Tasks.MyTasksActivity;
...
public class PrivatePublicProjectActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        issues.setOnClickListener(v -> startActivity(new Intent(PrivatePublicProjectActivity.this, IssuesActivity.class)));
