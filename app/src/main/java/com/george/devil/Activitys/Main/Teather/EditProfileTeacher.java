...
import com.george.devil.Activitys.Main.Pupil.ChangePasswordActivity;
...
public class EditProfileTeacher extends AppCompatActivity {
    ...
    void cleanErrors(){
        name_account_edit_profile_teather.getEditText().addTextChangedListener(new TextWatcher() {
            @Override
        ...
        username_layout_editProfile_teather.getEditText().addTextChangedListener(new TextWatcher() {
            @Override
            public void beforeTextChanged(CharSequence s, int start, int count, int after) {
                username_layout_editProfile_teather.setError(null);
            }
        ...
        email_layout_editProfile_tether.getEditText().addTextChangedListener(new TextWatcher() {
            @Override
            public void beforeTextChanged(CharSequence s, int start, int count, int after) {
                email_layout_editProfile_tether.setError(null);
            }
        ...
        city_layout_editProfile_teather.getEditText().addTextChangedListener(new TextWatcher() {
            @Override
            public void beforeTextChanged(CharSequence s, int start, int count, int after) {
                city_layout_editProfile_teather.setError(null);
            }
        ...
        topic_layout_teather.getEditText().addTextChangedListener(new TextWatcher() {
            @Override
            public void beforeTextChanged(CharSequence s, int start, int count, int after) {
        ...
        school_layout_editProfile_teather.getEditText().addTextChangedListener(new TextWatcher() {
            @Override
            public void beforeTextChanged(CharSequence s, int start, int count, int after) {
                school_layout_editProfile_teather.setError(null);
            }
        ...
        textField_bithday_edit_profile_teather.getEditText().addTextChangedListener(new TextWatcher() {
            @Override
            public void beforeTextChanged(CharSequence s, int start, int count, int after) {
                textField_bithday_edit_profile_teather.setError(null);
            }
